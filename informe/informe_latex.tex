...
%     pdflatex informe_latex.tex
%     pdflatex informe_latex.tex
%  O bien, en una sola orden (hace las pasadas automáticamente):
%     latexmk -pdf informe_latex.tex
%
...
Este es el punto metodológico más delicado del caso, tenemos que demostrar por que algunas variables constituyen data leakage.
